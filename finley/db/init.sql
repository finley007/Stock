...
select count(*) from simulation_result where factor_case = 'mfi_penetration_14_20210101_20220222' and profit_rate > 0 and version = '1.0';
select count(*) from simulation_result where factor_case = 'mfi_penetration_14_20210101_20220222' and profit_rate < 0 and version = '1.0';
select ts_code, profit_rate from simulation_result where factor_case = 'mfi_penetration_14_20210101_20220222' and profit_rate > 0 and version = '1.0' order by profit_rate desc;
select ts_code, profit_rate from simulation_result where factor_case = 'mfi_penetration_14_20210101_20220222' and profit_rate < 0 and version = '1.0' order by profit_rate desc;
select avg(profit_rate) from simulation_result where factor_case = 'mfi_penetration_14_20210101_20220222' and version = '1.0';
delete from simulation_result where factor_case = 'mfi_penetration_14_20210101_20220222';