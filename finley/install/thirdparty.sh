...
pip3 install pynverse -i http://mirrors.aliyun.com/pypi/simple/ --trusted-host mirrors.aliyun.com
pip3 install webdriver-manager -i http://mirrors.aliyun.com/pypi/simple/ --trusted-host mirrors.aliyun.com
...
pip3 install heapq -i http://mirrors.aliyun.com/pypi/simple/ --trusted-host mirrors.aliyun.com